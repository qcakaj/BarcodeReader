...
package com.ckj.barcodereader.camera

import android.os.SystemClock
import android.util.Log
import androidx.annotation.GuardedBy
import com.ckj.barcodereader.*
...
abstract class FrameProcessorBase<T> : FrameProcessor {
    ...
    private fun processLatestFrame(graphicOverlay: GraphicOverlay) {
        ...
        detectInImage(image)
            .addOnSuccessListener1(executor) { results: T ->
            ...
            .addOnFailureListener1(executor) { e -> OnFailureListener { this@FrameProcessorBase.onFailure(it) } }
    }
